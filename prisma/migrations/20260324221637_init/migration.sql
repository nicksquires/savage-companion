...
CREATE TABLE `Campaign` (
    ...
    `startingTemplateId` VARCHAR(191) NULL,
...
CREATE TABLE `PlayerJournalEntry` (
    ...
    UNIQUE INDEX `PlayerJournalEntry_sessionId_userId_characterId_key`(`sessionId`, `userId`, `characterId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `GMJournalEntry` (
    ...
    INDEX `GMJournalEntry_sessionId_gmId_idx`(`sessionId`, `gmId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `PlayerCharacter` (
    ...
    `wounds` INTEGER NOT NULL DEFAULT 0,
    `fatigue` INTEGER NOT NULL DEFAULT 0,
    `wealth` INTEGER NOT NULL DEFAULT 500,
    `description` VARCHAR(191) NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
...
CREATE TABLE `Creature` (
    ...
    INDEX `Creature_name_ownerId_sourceName_idx`(`name`, `ownerId`, `sourceName`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Race` (
    ...
    INDEX `Race_name_sourceName_ownerId_idx`(`name`, `sourceName`, `ownerId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Skill` (
    ...
    INDEX `Skill_name_sourceName_ownerId_idx`(`name`, `sourceName`, `ownerId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Edge` (
    ...
    INDEX `Edge_name_rank_category_sourceName_idx`(`name`, `rank`, `category`, `sourceName`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `ArcaneBackground` (
    ...
    INDEX `ArcaneBackground_name_sourceName_idx`(`name`, `sourceName`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Power` (
    ...
    INDEX `Power_name_rank_sourceName_idx`(`name`, `rank`, `sourceName`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Hindrance` (
    ...
    INDEX `Hindrance_name_severity_sourceName_idx`(`name`, `severity`, `sourceName`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `ItemInstance` (
    ...
    INDEX `ItemInstance_characterId_idx`(`characterId`),
    INDEX `ItemInstance_creatureId_idx`(`creatureId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Firearm` (
    ...
    INDEX `Firearm_mountType_idx`(`mountType`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `CampaignEdge` (
    ...
    INDEX `CampaignEdge_campaignId_idx`(`campaignId`),
...
CREATE TABLE `CampaignPower` (
    ...
    `isEnabled` BOOLEAN NOT NULL DEFAULT true,
    `customPowerPoints` INTEGER NULL,
    `notes` VARCHAR(191) NULL,

    INDEX `CampaignPower_campaignId_idx`(`campaignId`),
...
CREATE TABLE `CampaignSkill` (
    ...
    INDEX `CampaignSkill_campaignId_idx`(`campaignId`),
...
CREATE TABLE `CampaignHindrance` (
    ...
    INDEX `CampaignHindrance_campaignId_idx`(`campaignId`),
...
CREATE TABLE `CampaignSource` (
    ...
    INDEX `CampaignSource_campaignId_idx`(`campaignId`),
...
CREATE TABLE `PlayerCharacterEdge` (
    ...
    INDEX `PlayerCharacterEdge_playerCharacterId_idx`(`playerCharacterId`),
...
CREATE TABLE `PlayerCharacterArcaneBackground` (
    ...
    INDEX `PlayerCharacterArcaneBackground_playerCharacterId_idx`(`playerCharacterId`),
...
CREATE TABLE `PlayerCharacterPower` (
    ...
    INDEX `PlayerCharacterPower_playerCharacterId_idx`(`playerCharacterId`),
...
CREATE TABLE `PlayerCharacterSkill` (
    ...
    INDEX `PlayerCharacterSkill_playerCharacterId_idx`(`playerCharacterId`),
...
CREATE TABLE `PlayerCharacterHindrance` (
    ...
    INDEX `PlayerCharacterHindrance_playerCharacterId_idx`(`playerCharacterId`),
...
CREATE TABLE `CreatureAbility` (
    ...
    INDEX `CreatureAbility_creatureId_idx`(`creatureId`),
...
CREATE TABLE `CreatureEdge` (
    ...
    INDEX `CreatureEdge_creatureId_idx`(`creatureId`),
...
CREATE TABLE `CreatureSkill` (
    ...
    INDEX `CreatureSkill_creatureId_idx`(`creatureId`),
...
CREATE TABLE `EdgeTag` (
    ...
    INDEX `EdgeTag_edgeId_idx`(`edgeId`),
...
CREATE TABLE `PowerTag` (
    ...
    INDEX `PowerTag_powerId_idx`(`powerId`),
...
CREATE TABLE `CreatureTag` (
    ...
    INDEX `CreatureTag_creatureId_idx`(`creatureId`),
...
CREATE TABLE `SpecialAbilityTag` (
    ...
    INDEX `SpecialAbilityTag_specialAbilityId_idx`(`specialAbilityId`),
...
CREATE TABLE `SkillTag` (
    ...
    INDEX `SkillTag_skillId_idx`(`skillId`),
