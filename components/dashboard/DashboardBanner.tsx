      ...
      <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row items-start md:items-center gap-6">
        <div className="flex flex-row w-full">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-2xl md:text-4xl font-bold tracking-tight font-header">
              {user.name || "Adventurer"}
            </h1>

            {/* Underline divider */}
            <div className="h-0.5 w-full bg-primary mt-2 mb-1.5 md:mb-3" />

            {/* Subtext bar */}
            <div className="flex flex-wrap items-center gap-x-1.5 md:gap-x-4 text-xs md:text-sm opacity-90">
